...
<footer class="bg-secondary text-gray-400 pt-16 pb-6">
	<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
		<div class="grid md:grid-cols-2 lg:grid-cols-4 gap-10 pb-12 border-b border-white/10">
			...
			<div>
				<a href="#hero" class="flex items-center gap-2 mb-4">
					...
					<span class="text-2xl font-bold font-heading text-white">Jackie</span>
				</a>
				<p class="text-sm leading-relaxed">
					Building tomorrow's leaders through the art of karate. Discipline, strength,
					and confidence for every student.
				</p>
			</div>
			...
			<div>
				...
				<ul class="space-y-3 text-sm">
					<li class="flex items-start gap-2">
						...
						<span>+321 045 9876</span>
					</li>
					<li class="flex items-start gap-2">
						<span class="text-primary mt-0.5">✉️</span>
						<span>info@jackiekarate.com</span>
					</li>
					<li class="flex items-start gap-2">
						<span class="text-primary mt-0.5">📍</span>
						<span>1541 Oakwood Dr, Modesto, CA 95350</span>
					</li>
				</ul>
		...
		<div class="pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
			<p class="text-xs">© 2025 Jackie. All Rights Reserved.</p>
			<p class="text-xs">
				Designed with <span class="text-primary">♥</span> using SvelteKit + Tailwind CSS
			</p>
		</div>
	</div>
</footer>
